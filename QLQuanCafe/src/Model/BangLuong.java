...
public class BangLuong {
    ...
    public BangLuong(String maBangLuong, String maNhanVien, Date thang, int soNgayCong, int soNgayNghiCoCong, int soNgaynghiKhongCong, int soGioLamThem, int thuongDoanhThu, int luongThucNhan, String ghiChu, boolean duocPhepChinhSua) {
